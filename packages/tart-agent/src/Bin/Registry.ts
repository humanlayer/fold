/**
 * This file is the data half of tart's managed binaries (D18): the pinned registry of the external
 ...
 * digests with `bun packages/tart-agent/scripts/update-managed-binaries.ts`.
 *
...
export type ManagedBinaryDefinition = {
	/** Canonical name - the file name installed into `<tartHome>/bin` and the one prompts use. */
