	...
	return (
		...
		>
			<box flexDirection="row">
				<ascii-font text="F" font="tiny" color={color.core} />
				<ascii-font text="O" font="tiny" color={color.coreBright} />
				<ascii-font text="L" font="tiny" color={color.core} />
				<ascii-font text="D" font="tiny" color={color.coreDim} />
			</box>
