...
import { anthropicModel, defineAgent, defineSubagent, startSession, subagentTool } from '@humanlayer/tart-core'
...
const makeProgram = (apiKey: string) =>
	Effect.gen(function* () {
		const workspace = mkdtempSync(join(tmpdir(), 'tart-subagents-demo-'))
