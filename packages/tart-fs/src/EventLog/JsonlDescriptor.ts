 ...
 */
import { eventLogSource, EventLog, type TartEventLog } from '@humanlayer/tart-core'
...
export const jsonlEventLog = (filePath: string, options?: JsonlEventLogOptions): TartEventLog =>
	eventLogSource(
		Effect.gen(function* () {
