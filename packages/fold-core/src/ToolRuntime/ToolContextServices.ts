...
export class ToolEventSink extends Context.Service<ToolEventSink, ToolEventSinkService>()('fold/ToolEventSink') {}
...
export class ToolEvents extends Context.Service<ToolEvents, ToolEventsService>()('fold/ToolEvents') {}
 ...
 */
export class StopController extends Context.Service<StopController, StopControllerService>()('fold/StopController') {}
...
export class CurrentAgent extends Context.Service<CurrentAgent, CurrentAgentService>()('fold/CurrentAgent') {}
...
export class InterruptNote extends Context.Service<InterruptNote, InterruptNoteService>()('fold/InterruptNote') {}
