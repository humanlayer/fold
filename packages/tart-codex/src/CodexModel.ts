/**
 * The tart-codex model descriptor: clanka's shape over the official `@effect/ai-openai` provider
...
import { customModel, resolveCodexReasoning } from '@humanlayer/tart-core'
import type { ReasoningLevel, TartModel } from '@humanlayer/tart-core'
...
export type CodexModelOptions = {
	...
	/** Credential store override. Defaults to the `codex` entry of `~/.tart/auth.json`. */
 ...
 */
export const codexModel = (options: CodexModelOptions): TartModel => {
