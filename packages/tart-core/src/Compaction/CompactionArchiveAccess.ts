 ...
 * that own a durable log path (tart-agent's JSONL sessions) decide what, if anything, to render.
 */
...
export const noopCompactionArchiveAccess: CompactionArchiveAccessService = {
	instructions: Effect.fn('tart.compaction_archive_access.instructions')(() => Effect.succeed(null)),
}
