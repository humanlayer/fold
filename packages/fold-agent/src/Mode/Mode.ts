 ...
 * Mode/Subagents). Other modes are just other `FoldMode` values (Mode/Rlm); Mode/ModeName maps the
...
export const DEFAULT_CODING_PROMPT: string =
	"You are fold, a headless coding agent working in the user's project directory. " +
...
export const defaultCodingMode: FoldMode = {
	name: 'coding',
	role: 'smart',
