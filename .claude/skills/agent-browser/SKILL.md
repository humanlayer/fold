...
<important if="you are using the rpi:create-structure-outline or rpi:create-plan skill">
...
<important if="you are using the rpi:implement-plan or rpi:iterate-implementation or rpi:implement-outline skill">
